...
# Get tensorflow INCLUDE and Library
...
# TF 1.13
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC   -I /home/jiaaodong/anaconda3/envs/pointnet2/lib/python3.7/site-packages/tensorflow/include -I /usr/local/cuda-10.0/include -I /home/jiaaodong/anaconda3/envs/pointnet2/lib/python3.7/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-10.0/lib64/ -L  /home/jiaaodong/anaconda3/envs/pointnet2/lib/python3.7/site-packages/tensorflow -l tensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
